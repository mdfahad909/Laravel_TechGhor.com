...
<form action="{{ route('team.update', $team->id) }}" method="post" id="team-form" class="general-form"  accept-charset="utf-8" novalidate="novalidate">
    @method('PUT')
@csrf
...
<div class="form-group">
    <div class="row">
        ...
        <div class="col-md-9">
            <input type="text" name="name" value="{{ old('name',$team->name) }}" id="name" required class="form-control" placeholder="{{ __('Name') }}">
        </div>
            @error('name')
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <select name="position" id="position" class="form-control">
                <option value="{{ $team->post }}" selected >{{ $team->post }}</option>
