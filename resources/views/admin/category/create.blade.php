...
<form action="{{ route('category.store') }}" method="post" id="category-form" class="general-form"  accept-charset="utf-8" novalidate="novalidate">
@csrf
...
<div class="modal-body clearfix" id="sshmieul">
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-9">
                <input type="text" name="category_name" id="category_name"  class="form-control" placeholder="{{ __('Category Name') }}">
            </div>
                @error('category_name')
