...
@section('title',__('Our Team Member'))
...
@section('content')
        <div class="scrollable-page main-scrollable-page">
            <div id="page-content" class="page-wrapper clearfix">
                <div class="clearfix">
                    <ul id="client-tabs" data-bs-toggle="ajax-tab" class="nav nav-tabs bg-white title" role="tablist">
                        ...
                        <li>
                            <a role="presentation" href="{{ route('team_list') }}" data-bs-target="#team_list">{{ __('Our Team') }}</a>
                        </li>
                        <div class="tab-title clearfix no-border">
                            <div class="title-button-group"> 
                                <a href="#" class="btn btn-default" title="{{ __('Create Team') }}" data-act="ajax-modal" data-title="{{ __('Create Team') }}" data-method="get" data-action-url="{{ route('team.create') }}"><i data-feather='plus-circle' class='icon-16'></i> {{ __('Team Create') }}</a>
                            </div>
                        </div>
                    </ul>
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="team_list"></div>
                    </div>
                </div>
            </div>
            <script type="text/javascript">
            $(document).ready(function() {
                setTimeout(function() {
                    var tab = "";
                    if(tab === "team_list" || tab === "team_list-has_open_projects") {
                        $("[data-bs-target='#team_list']").trigger("click");
