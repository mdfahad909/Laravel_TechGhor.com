<div class="card">
    <div class="table-responsive">
        <table id="post-table" class="display" cellspacing="0" width="100%">
        </table>
    </div>
</div>
...
<script type="text/javascript">
    ...
    var quick_filters_dropdown = @include('admin.post.partials.quick_filters_dropdown');
